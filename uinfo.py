...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--path', help="待加载的文件路径", required=False)
    parser.add_argument('-d', '--domain', help="请求的单个主域名", required=False)
    parser.add_argument('-w', '--word', help="字典路径,和-d参数一起使用，如果不加则默认为当前目录下的dicc.txt", default='dicc.txt',required=False)
